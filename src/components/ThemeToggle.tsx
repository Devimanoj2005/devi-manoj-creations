...
const ThemeToggle = () => {
  ...
  return (
    <Button
      ...
      className="relative overflow-hidden hover:scale-110 transition-all duration-300 hover:bg-accent group bg-card/80 backdrop-blur-lg border border-border/50 shadow-soft hover:shadow-glow opacity-0"
    >
