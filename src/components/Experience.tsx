        ...
        <div className="relative">
          ...
          <div className="space-y-10 animate-slide-in">
            {experiences.map((item, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-4 md:left-1/2 w-4 h-4 rounded-full bg-primary border-4 border-background -translate-x-1/2 z-10 mt-6 md:mt-0" />

                {/* Spacer for alternate side */}
                <div className="hidden md:block md:w-1/2" />

                {/* Card */}
                <Card className="ml-10 md:ml-0 md:w-1/2 p-6 border-border/50 hover:shadow-xl transition-all duration-500 group hover:border-primary/30">
